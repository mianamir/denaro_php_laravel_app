...
<head>
    ...
    <link rel="stylesheet" href="{{asset('admin2/font/font-awesome/css/font-awesome.min.css')}}">
    <!-- Ionicons -->
    <!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">-->
    <link rel="stylesheet" href="{{asset('admin2/icon/css/ionicons.min.css')}}">
    <!-- Theme style -->
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('admin2/plugins/iCheck/flat/blue.css')}}">
    <!-- Morris chart -->
    {{--<link rel="stylesheet" href="{{asset('admin2/plugins/morris/morris.css')}}">--}}
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{asset('admin2/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{asset('admin2/plugins/datepicker/datepicker3.css')}}">
    <!-- Daterange picker -->
    ...
    <link rel="stylesheet" href="{{asset('admin2/jquery-ui/jquery-ui.min.css')}}">
...
{{--<link rel="stylesheet" href="{{asset('admin2/datatables/media/css/jquery.dataTables.min.css')}}">--}}
<style>
...
<div class="wrapper">
@include('admin2.header.header')
@include('admin2.sidebar.sidebar')
...
<script src="{{asset('admin2/jquery-ui/jquery-ui.min.js')}}"></script>
...
{{--<script src="{{asset('admin2/plugins/morris/morris.min.js')}}"></script>--}}
<!-- Sparkline -->
<script src="{{asset('admin2/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('admin2/plugins/knob/jquery.knob.js')}}"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="{{asset('admin2/plugins/daterangepicker/daterangepicker.js')}}"></script>
<!-- datepicker -->
<script src="{{asset('admin2/plugins/datepicker/bootstrap-datepicker.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{asset('admin2/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
<!-- Slimscroll -->
<script src="{{asset('admin2/plugins/slimScroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
<script src="{{asset('admin2/plugins/fastclick/fastclick.js')}}"></script>
...
{{--<script src="{{asset('admin2/datatables/media/js/jquery.dataTables.js')}}"></script>--}}
