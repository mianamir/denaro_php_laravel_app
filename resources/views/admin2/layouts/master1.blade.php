...
<head>
    ...
    <title>@yield('title') - Servaid Pharmacy Application</title>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <b>Developed By:</b> <a href="https://infotech4it.com" target="_blank">InfoTech4It</a>
        </div>
        <strong>Copyright &copy; 2017 <a href="{{url('dashboard')}}">Servaid Pharmacy</a>.</strong> All rights
        reserved.
    </footer>
