                                ...
                                <div class="mc-item mc-item-2">
                                    <div class="image-heading">
                                        @if($student->profile_pic != null)
                                            <image src="{{asset('students/'.$student->profile_pic)}}" width="100" height="100" alt="{{$student->name}}"/>
                                        @else
                                            <image src="{{asset('students/image_320_240.jpg')}}" alt="{{$student->name}}"/>
