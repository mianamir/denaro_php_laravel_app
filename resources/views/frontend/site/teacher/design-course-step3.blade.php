    ...
    <section id="course-concern" class="course-concern">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- MC ITEM -->
                    <form action="{{route('post.design.course.step2', ['id' => $course->id])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        {{--<div class="form-question mc-select">--}}
                            {{--<select name="is_featured" class = "select" required>--}}
                                {{--<option value="1">Is Featured</option>--}}
                                {{--<option value="0">Is Not Featured</option>--}}
                            {{--</select>--}}
                        {{--</div>--}}
                        <br><br>
