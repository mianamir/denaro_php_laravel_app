            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="request-form">
                        <h2>{{$teacher->name}}: please complete your profile</h2>
                        <form action="{{route('become.teacher.step2.post')}}" method="post" enctype="multipart/form-data">
                            ...
                            @endif
                            @if(Session::has('not_found_flash_message'))
                                <div class="alert alert-info">
                                {{ Session::get('not_found_flash_message') }}
                                </div>
                            @endif
