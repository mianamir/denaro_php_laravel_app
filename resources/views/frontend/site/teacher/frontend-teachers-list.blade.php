                                ...
                                <div class="mc-item mc-item-2">
                                    <div class="image-heading">
                                        @if($teacher->profile_pic != null)
                                            <image src="{{asset('teachers/'.$teacher->profile_pic)}}" width="100" height="100" alt="{{$teacher->name}}"/>
                                        @else
                                            <image src="{{asset('teachers/image_320_240.jpg')}}" alt="{{$teacher->name}}"/>
