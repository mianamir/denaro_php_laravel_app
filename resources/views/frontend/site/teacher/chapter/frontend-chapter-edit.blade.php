    ...
    <section id="course-concern" class="course-concern">
        <div class="container">
            ...
            <div class="price-course">
                ...
                <h3>{{$course->title}} / Edit Chapter</h3>
                {{--<span>$ 29,278</span>--}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- MC ITEM -->
                    <form action="{{route('post.frontend.chapter.edit', ['id' => $chapter->id])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <input type="hidden" name="subject_id" value="{{$chapter->subject->id}}">
                    <div class="col-md-12">
                        <div class="form-yourname">
                            <input type="text"  placeholder="Title" name="title" value="{{old('title', $chapter->title)}}" class="form-control" required>
                        </div>
