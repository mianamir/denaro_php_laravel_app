    ...
    <section id="course-concern" class="course-concern">
        <div class="container">
            ...
            <div class="price-course">
                ...
                <h3>{{$chapter->title}} / edit topic</h3>
                {{--<span>$ 29,278</span>--}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- MC ITEM -->
                    <form action="{{route('post.frontend.topic.edit')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-yourname">
                            <input type="text"  placeholder="Title" name="title" value="{{old('title', $topic->title)}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-yourname">
                            <input type="text"  placeholder="Topic Video URL" name="topic_video" value="{{old('topic_video', $topic->topic_video)}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4">
