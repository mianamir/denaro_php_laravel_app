                ...
                <table class="table table-responsive table-hover" id="myTable" data-order='[[ 0, "desc" ]]'>
                    ...
                    @foreach($teachers as $teacher)
                        <tr>
                            ...
                            <td>{!! $teacher->name !!}</td>
                            <td>{!! isset($teacher->course_to_teach->title) ? $teacher->course_to_teach->title : "Not Available" !!}</td>
                            {{--<td><a href="{{route('admin.teachers.courses', ['id' => $teacher->id])}}"> {!! $teacher->courses->count() != null ? $teacher->courses->count() : "Not Available" !!} </a></td>--}}
                            <td>{!! $teacher->email !!}</td>
                            <td>
