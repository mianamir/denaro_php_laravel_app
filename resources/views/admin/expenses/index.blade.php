...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-2">
                <h5 style="text-align: center">Product Expense: <strong>{{$totalProductExpenses}}</strong></h5>
            </div>
            <div class="col-md-2">
                <h5 style="text-align: center">Supplier Expense: <strong>{{$totalsupplierExpenses}}</strong></h5>
            </div>
            <div class="col-md-2">
                <h5 style="text-align: center">Employee Expense: <strong>{{$totalemployeeExpenses}}</strong></h5>
            </div>
            <div class="col-md-2">
                <h5 style="text-align: center">Other Expense: <strong>{{$totalotherExpenses}}</strong></h5>
            </div>
            <div class="col-md-4">
                <h5 style="text-align: center">Total Expense: <strong>{{$totalExpenses}}</strong></h5>
            </div>
        </div>
