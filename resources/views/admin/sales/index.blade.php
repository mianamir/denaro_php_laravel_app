...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-3">
                <h5 style="text-align: center">Total Completed Sales Amount: <strong>{{$completedSalesTotalAmount}}</strong></h5>
            </div>
            <div class="col-md-3">
                <h5 style="text-align: center">Total Pending Sales Amount: <strong>{{$pendingSalesTotalAmount}}</strong></h5>
            </div>
            <div class="col-md-3">
                <h5 style="text-align: center">Total Sales Amount: <strong>{{$salesTotalAmount}}</strong></h5>
            </div>
            <div class="col-md-3">
                <h5 style="text-align: center">Total Sales Remaining Amount: <strong>{{$salesTotalRemainingAmount}}</strong></h5>
            </div>
        </div>
