    ...
    <!-- Sidebar user panel -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Active::pattern('admin/headers/*') }}">
                {{ link_to_route('admin.headers.index', 'Header') }}
            </li>
            ...
            {{ link_to_route('admin.banners.index', 'Banners') }}
            </li>
            ...
            {{ link_to_route('admin.galleries.index', 'Gallery') }}
            </li>
        ...
        <!--            <li class="{{ Active::pattern('admin/certifications/*') }}">
            ...
            {{ link_to_route('admin.news.index', 'News ') }}
            {{--</li>--}}
            ...
            <li class="{{ Active::pattern('admin/customers/*') }}">
                {{ link_to_route('admin.customers.index', 'Staff') }}
            </li>
            {{--<li class="treeview">--}}
