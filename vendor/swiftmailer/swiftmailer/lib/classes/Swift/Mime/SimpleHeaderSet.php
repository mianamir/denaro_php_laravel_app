...
class Swift_Mime_SimpleHeaderSet implements Swift_Mime_HeaderSet
{
    ...
    /**
     * Set the charset used by these _headers.
     *
     * @param string $charset
     */
     ...
     *
     * If multiple _headers match, the actual one may be specified by $index.
     *
     * @param string $name
     * @param int    $index
     *
    ...
    /**
     * Get all _headers with the given $name.
     *
     * @param string $name
     *
     * @return array
    ...
    /**
     * Remove all _headers with the given $name.
     *
     * @param string $name
     */
     ...
     *
     * Usually _headers without a field value won't be output unless set here.
     *
     * @param array $names
     */
    ...
    /**
     * Returns a string with a representation of all _headers.
     *
     * @return string
     */
    ...
    /** Test if the _headers can be sorted */
