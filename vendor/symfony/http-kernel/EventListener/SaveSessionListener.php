...
/**
 * Saves the session, in case it is still open, before sending the response/_headers.
 *
 ...
 *    be saved anyway before sending the _headers with the new session ID. Otherwise session
