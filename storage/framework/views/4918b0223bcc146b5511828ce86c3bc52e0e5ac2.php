        ...
        <div class="container">
            ...
            <div class="price-course">
                ...
                <div class="create-coures">
                    <?php /*<a href="<?php echo e(route('student.course.register', [$student->id])); ?>" class="mc-btn btn-style-1">Take New Course + </a>*/ ?>
            ...
            <div class="row">
                ...
                ->first();
                ?>
                <?php if(isset($course) && $student_course->status == 'active'): ?>
                        ...
                        <div class="mc-item mc-item-2">
                            <div class="image-heading">
                                <?php if($course->image != null): ?>
                                    <a target="_blank" href="<?php echo e(route('frontend.course.intro', ['id'=>$course->id])); ?>">
                ...
                <?php endif; ?>
                <?php if(isset($course) && $student_course->status == 'inactive'): ?>
                    <div class="col-xs-6 col-sm-4 col-md-3">
                        ...
                        <div class="mc-teaching-item mc-item mc-item-2">
                            <div class="mc-item mc-item-2">
                                ...
                                <div class="meta-categories"><a href="#"><?php echo e($student_course->status); ?></a></div>
                                <div class="content-item">
                                    <div class="image-author">
                                        <img src="<?php echo e(asset('assets/images/avatar-1.jpg')); ?>" alt="">
                                    </div>
                                    <h3 style="font-size: 17px;font-weight: 700;"><a target="_blank" href="<?php echo e(route('frontend.course.intro', ['id'=>$course->id])); ?>"><?php echo $course->title; ?></a></h3>
                                    <p style="font-size: 14px;"><?php echo str_limit($course->short_details, 80); ?></p>
                                    <div class="name-author">
                                        Price <a href="#"> <?php echo e($course->price); ?></a>
                                    </div>
                                ...
                                <div class="edit-view">
                                    ...
                                    <a href="#" class="view">Chapters(<?php echo e(isset($chapters_count) ? $chapters_count : 0); ?>)</a>
                                </div>
                            </div>
                        </div>
                        <!-- END / ITEM -->
