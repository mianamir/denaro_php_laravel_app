<aside class="main-sidebar">
    ...
    <!-- Sidebar user panel -->
        ...
        <!--            <li class="<?php echo e(Active::pattern('admin/certifications/*')); ?>">
            ...
            <?php /*</li>*/ ?>
            <?php /*<li class="<?php echo e(Active::pattern('admin/socialIcons/*')); ?>">*/ ?>
            <?php /*<?php echo e(link_to_route('admin.socialIcons.index', 'Social Icons Management')); ?>*/ ?>
            <?php /*</li>*/ ?>
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(route('admin.studentClasses.index')); ?>"><i class="fa fa-circle-o"></i>Student Management</a></li>
            ...
            <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(route('admin.studentClasses.index')); ?>"><i class="fa fa-circle-o"></i>Teacher Management</a></li>
            ...
            <li><a href="<?php echo e(route('admin.subjectTypes.index')); ?>"><i class="fa fa-circle-o"></i>Subject Type Management</a></li>
            <li><a href="<?php echo e(route('admin.subjects.index')); ?>"><i class="fa fa-circle-o"></i>Subject Management</a></li>
            <li><a href="<?php echo e(route('admin.classSubjects.index')); ?>"><i class="fa fa-circle-o"></i>Class Subjects Management</a></li>
            <li><a href="<?php echo e(route('admin.chapters.index')); ?>"><i class="fa fa-circle-o"></i>Chapter Management</a></li>
            <li><a href="<?php echo e(route('admin.topics.index')); ?>"><i class="fa fa-circle-o"></i>Topic Management</a></li>
