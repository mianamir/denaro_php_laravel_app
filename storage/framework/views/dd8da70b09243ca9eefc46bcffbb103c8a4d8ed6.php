    ...
    <section id="course-concern" class="course-concern">
        <div class="container">
            ...
            <div class="price-course">
                ...
                <h3><?php echo e($course->title); ?> / Edit Chapter</h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- MC ITEM -->
                    <form action="<?php echo e(route('post.frontend.chapter.edit', ['id' => $chapter->id])); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <input type="hidden" name="subject_id" value="<?php echo e($chapter->subject->id); ?>">
                    <div class="col-md-12">
                        <div class="form-yourname">
                            <input type="text"  placeholder="Title" name="title" value="<?php echo e(old('title', $chapter->title)); ?>" class="form-control" required>
                        </div>

                        <div class="description-editor text-form-editor">
                            <textarea placeholder="Discussion content" name="details" id="details">
                                <?php echo $chapter->details; ?>
