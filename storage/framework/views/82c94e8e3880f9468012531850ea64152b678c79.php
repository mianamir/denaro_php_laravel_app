                                ...
                                <div class="mc-item mc-item-2">
                                    <div class="image-heading">
                                        <?php if($student->profile_pic != null): ?>
                                            <image src="<?php echo e(asset('students/'.$student->profile_pic)); ?>" width="100" height="100" alt="<?php echo e($student->name); ?>"/>
                                        <?php else: ?>
                                            <image src="<?php echo e(asset('students/image_320_240.jpg')); ?>" alt="<?php echo e($student->name); ?>"/>
                                    ...
                                    <div class="content-item">
                                        <div class="name-author">
                                            Name <a href="#"> <?php echo e($student->name); ?></a>
                                        </div>
                                    </div>
