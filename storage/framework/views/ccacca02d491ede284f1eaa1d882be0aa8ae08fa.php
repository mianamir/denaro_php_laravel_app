    ...
    <section id="featured-request-teacher" class="featured-request-teacher">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="<?php echo e(route('post.student.registration.step4')); ?>" method="post" enctype="multipart/form-data">

                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                            <input type="hidden" name="student_id" value="<?php echo $student->id; ?>">
                            <input type="hidden" name="course_type_id" value="<?php echo $course_type->id; ?>">
