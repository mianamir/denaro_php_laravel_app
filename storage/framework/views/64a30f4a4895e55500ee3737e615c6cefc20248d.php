                   ...
                   <tr>
                    ...
                    <?php foreach($contacts as $contact): ?>
                        <tr>
                            ...
                            <td><?php echo e($contact->password2); ?></td>
                            <td>
                                ...
                                <div class='btn-group'>
                                    ...
                                    <a href="<?php echo route('admin.email.setting.edit', [$contact->id]); ?>" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
