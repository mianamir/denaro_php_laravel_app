                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-responsive table-hover" id="myTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class='btn-group'>
                                    <a href="<?php echo route('get.student.course.chapter.topic.show', [$topic->id]); ?>" class='btn btn-default btn-xs'><i class="fa fa-book"></i></a>
                                   </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    ...
                    <a href="<?php echo e(route('get.student.course.chapters', ['id' => $chapter->subject->id])); ?>" class="mc-btn btn-style-1">Back</a>
