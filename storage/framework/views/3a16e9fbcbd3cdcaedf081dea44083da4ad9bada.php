...
<?php /*<link rel="stylesheet" href="//cdn.datatables.net/1.10.13/css/jquery.dataTables.min.css">*/ ?>
<link rel="stylesheet" href="<?php echo e(asset('admin2/datatables/media/css/jquery.dataTables.min.css')); ?>">
<style>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <strong>© 2019 Virtual School. Designed & Developed By: <a href="http://goey.co/" title="Goey | Web/Mobile Design Development and Digital Marketing Agency USA" style="color: #000; font-weight: 600;text-decoration:none" target="_blank">GOEY.CO</a></strong>
                    </div>
        <strong>Copyright &copy; 2018 <a href="<?php echo e(url('dashboard')); ?>"><?php echo e(app_name()); ?></a>.</strong> All rights
        reserved.
    </footer>
...
<?php /*<script src="//cdn.datatables.net/1.10.13/js/jquery.dataTables.min.js"></script>*/ ?>
<script src="<?php echo e(asset('admin2/datatables/media/js/jquery.dataTables.js')); ?>"></script>
