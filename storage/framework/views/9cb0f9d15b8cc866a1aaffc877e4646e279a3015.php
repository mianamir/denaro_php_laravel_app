        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    ...
                    <a href="<?php echo route('admin.courses.by.class', [$studentClass->id]); ?>" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-list"></i></a>
                    <a href="<?php echo route('admin.students.by.class.index', [$studentClass->id]); ?>" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-user"></i></a>
