            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="request-form">
                        ...
                        <form action="<?php echo e(route('post.student.registration.step1')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-yourname">
                                ...
                                <input type="password" placeholder="Password, should be 6 digits long i.e 123!$#" name="password" class="form-control" required>
                            </div>
                            <div class="form-yourname">
